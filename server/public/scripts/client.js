...
function appendToDom (tasks){
  console.log('Appending to DOM' ,tasks);
...
if (task.complete == "false") {
  ...
  $tr.append('<td class="edittask" id ="completedTask">'+ task.task +'</td>');
}

    $tr.append('<td>'+ '<button class ="completeBtn"data-compid="' + task.id+ '">✔</button"</td>');
    $tr.append('<td>'+ '<button class ="deleteBtn" data-taskid="' + task.id + '">X</button"</td>');
    $('#viewTasks').append($tr);
  }
}
